...
\multicolumn{3}{l}{\small Equity decreases because liabilities increase while assets are unchanged (Equity $=$ Assets $-$ Liabilities).}
\end{tabular}
\end{center}
