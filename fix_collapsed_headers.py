...
# Find and fix line 984 (index 983)
if len(lines) > 983:
    # This line has everything collapsed
    old_line = lines[983]

    # Replace the collapsed headers with properly formatted ones
    new_content = """## Numerical Methods
