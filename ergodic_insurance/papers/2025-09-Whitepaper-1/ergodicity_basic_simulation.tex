...
\begin{itemize}
    ...
    \item Over-reliance on peer benchmarking, potentially setting up systemic antipatterns
\end{itemize}

\subsection{The Promise of Ergodicity Economics}

Ergodicity economics, developed by \citet{peters2025ergodicity} as a generalization of \citet{kelly1956new}, offers a new perspective on decision-making under uncertainty. Unlike traditional expected utility theory, which focuses on ensemble averages, ergodicity economics emphasizes the importance of time averages and growth rates.

In this paper, we apply ergodicity economics principles to develop a simulation framework that captures the temporal dynamics of insurance appetite. This approach allows us to analyze how different company characteristics influence optimal insurance strategies over time.

We discover that insurance appetite varies significantly with company size, measured by capitalization and revenue. Smaller companies tend to favor lower deductibles despite higher relative premium costs, while larger companies can afford higher retentions. In most cases, insurance provides a growth advantage over self-insurance, although the magnitude of this advantage diminishes for larger firms, and some level of risk retention if often preferable to guaranteed cost options. These findings have profound implications for underwriting, risk management, and regulatory practices in the insurance industry.
