...
from ergodic_insurance.src.manufacturer import WidgetManufacturer, ClaimLiability
...
class TestWidgetManufacturer:
    ...
    def test_calculate_collateral_costs(self, manufacturer):
        ...
        costs = manufacturer.calculate_collateral_costs(letter_of_credit_rate=0.015, time_period="annual")
        assert costs == 15_000  # 1M * 0.015
        
        # With collateral - monthly
        costs = manufacturer.calculate_collateral_costs(letter_of_credit_rate=0.015, time_period="monthly")
