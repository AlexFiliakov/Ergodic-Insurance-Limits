...
{\color{red}
\textbf{Insurance Program Structure:}
\begin{itemize}[nosep]
...
\textbf{Insurance Pricing:}
\begin{itemize}[nosep]
    \item Market cycle modeling (hard, normal, soft markets) with cycle transition simulation
...
\begin{itemize}[nosep]
    ...
    \item Working capital management (accounts receivable, inventory, accounts payable) with DSO/DIO/DPO ratios
    \item Property, plant \& equipment with depreciation expense tracking
    \item Prepaid insurance asset recognition with monthly amortization
    \item GAAP-compliant income statements, balance sheets, and cash flow statements
\end{itemize}
