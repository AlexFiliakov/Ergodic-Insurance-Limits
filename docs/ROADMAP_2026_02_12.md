...
```bash
cd "C:/worktrees/fix-1302-revenue-cash-double-count";claude --dangerously-skip-permissions
cd "C:/worktrees/fix-1355-stderr-ess";claude --dangerously-skip-permissions
cd "C:/worktrees/fix-1318-exact-penalty";claude --dangerously-skip-permissions
cd "C:/worktrees/fix-1353-convergence-pseudo-chains";claude --dangerously-skip-permissions
cd "C:/worktrees/fix-1334-point-elasticity";claude --dangerously-skip-permissions
cd "C:/worktrees/perf-1347-gpu-scatter-vectorize";claude --dangerously-skip-permissions
```
