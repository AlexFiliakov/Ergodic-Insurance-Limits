...
- Gwern Branwen: [Full Text](https://gwern.net/doc/statistics/decision/1975-thorp.pdf)
...
**chainladder-python**
- Website: [chainladder-python.readthedocs.io](https://chainladder-python.readthedocs.io/)
- Documentation: [chainladder-python user guide](https://chainladder-python.readthedocs.io/en/latest/user_guide/)
...
**quActuary**
- Website: [quactuary.com](https://quactuary.com/)
- Documentation: [docs.quactuary.com](https://docs.quactuary.com/)
...
Filiakov, A. (2026). Ergodic Insurance Limits: Optimizing insurance using time-average growth [Software]. GitHub.
...
All references have been verified as of February 2026. Some resources may change over time. For the most current information:
